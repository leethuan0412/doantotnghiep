...
export default function ShoppingCarts({route}) {
  ...
  function SendNotification() {
    ...
    const data = {
      ...
      include_player_ids: ['b0742157-f8cd-41bb-84e2-57cb397ed4ee'],
                  ...
                  <View style={styles.cardContent}>
                    ...
                    {useDiscount == item.id && discount > 0 && (
                      <TouchableOpacity
                        ...
                        <Text style={{textAlign: 'center', fontSize: 13,height:30,width:40,bottom:1.5}}>
                          Bỏ chọn
                        </Text>
                      </TouchableOpacity>
                    )}
...
// console.log(sheetRef.current,"hhhh")
